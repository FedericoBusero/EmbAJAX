...
public:
    ...
    void print() const override {
        ...
        EmbAJAXBase::_driver->printContent(
           ...
           "        y = event.changedTouches[i].clientY - this.offsetTop;\n" 
           "      }\n"
           "    }\n"
           "  } else {\n"
           "      x = event.offsetX;\n"
        ...
        EmbAJAXBase::_driver->printContent(
           ...
           "elem.addEventListener('touchstart', function(event) { this.touchid = event.changedTouches[0].identifier; this.press(event.touches[0].clientX-this.offsetLeft, event.touches[0].clientY-this.offsetTop); }.bind(elem), false);\n"
